...
/*     this.setState({isLoading: true})
  ...
  render() {
    ...
    const category = [ 'MyProjects', 'RepairCar', 'MyPhoto', 'ThingUSSR', 'Thing90', 'HistCher', 'MyNotes' ]
    return (
      <React.Fragment>
        <div className='header'>
          ...
          <div className='HeaderLink'>
            <a href='#linkStat' className='HeaderMenu'>Статистика</a><br />
            <a href='#linkAbout' className='HeaderMenu'>О сайте</a>
          </div>
        </div>
        <div className = 'Body' >
